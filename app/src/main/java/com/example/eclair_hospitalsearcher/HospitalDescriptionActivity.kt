...
class HospitalDescriptionActivity : AppCompatActivity() {
    ...
    val listDoctors:List<String> = listOf("James Cameron", "Dalas Azahar", "Dr. House", "Dr. Vic", "Carolina Wieser", "Erick Saucedo", "Aaron Barrera", "William Osler", "Sigmund Freud", "Derek Styles", "Alexander Fleming")
