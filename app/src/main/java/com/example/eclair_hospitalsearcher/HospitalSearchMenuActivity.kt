...
class HospitalSearchMenuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val hospitalOptionsList = listOf(
            ...
            HospitalOption("Hospital General Riberalta", details,vaccineUnavailable,R.drawable.icon_vaccine_unavailable, R.drawable.image_hospital_general_riberalta, R.drawable.icon_three_stars, 43191911, "Riberalta S/N","geo:-11.00001106574481, -66.0595575"),
